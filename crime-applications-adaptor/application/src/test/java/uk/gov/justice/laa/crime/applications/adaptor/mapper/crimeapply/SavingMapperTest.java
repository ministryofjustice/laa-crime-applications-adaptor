...
public class SavingMapperTest {
    ...
    @BeforeEach()
    void setUp() { savingMapper = new SavingMapper(); }

    @ParameterizedTest
    @MethodSource("savingTypeMappingTestData")
    void shouldMapFromCrimeApplySavingTypeToCrimeApplicationsCapitalType(Saving.SavingType inputCrimeApplySavingType,
                                                                         CapitalOther.CapitalType expectedCapitalType) {
        CapitalOther.CapitalType actualCapitalType = savingMapper.mapSavingsTypeToCapitalType(inputCrimeApplySavingType);
    ...
    void shouldMapFromCrimeApplyOwnershipTypeToCrimeApplicationsAccountOwner(Saving.OwnershipType inputCrimeApplyOwnershipType,
                                                                         CapitalOther.AccountOwner expectedAccountOwner) {
        CapitalOther.AccountOwner actualAccountOwner = savingMapper.mapSavingOwnershipTypeToAccountOwner(inputCrimeApplyOwnershipType);
