...
import uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.ThirdPartyOwner;
...
class PropertyMapperTest {
  ...
  void shouldMapFromCrimeApplyPropertyTypeToCrimeApplicationsPropertyType(
      Property.PropertyType inputCrimeApplyPropertyType,
      Property.HouseType inputCrimeApplyHouseType,
      uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.Property.PropertyType
  ...
  void shouldMapFromCrimeApplyRelationshipToCrimeApplicationsOwnerRelation(
      PropertyOwner.Relationship inputCrimeApplyRelationship,
  ...
  private static Stream<Arguments> relationshipMappingTestData() {
    return Stream.of(
        ...
        Arguments.of(
            PropertyOwner.Relationship.EX_PARTNER, ThirdPartyOwner.OwnerRelation.EX_PARTNER),
        Arguments.of(
            PropertyOwner.Relationship.BUSINESS_ASSOCIATES, ThirdPartyOwner.OwnerRelation.BUSINESS),
        Arguments.of(
            PropertyOwner.Relationship.FAMILY_MEMBERS, ThirdPartyOwner.OwnerRelation.FAMILY),
        Arguments.of(PropertyOwner.Relationship.FRIENDS, ThirdPartyOwner.OwnerRelation.FRIENDS),
        Arguments.of(
            PropertyOwner.Relationship.HOUSE_BUILDER, ThirdPartyOwner.OwnerRelation.BUILDER),
        Arguments.of(
            PropertyOwner.Relationship.HOUSING_ASSOCIATION,
            ThirdPartyOwner.OwnerRelation.HOUSING_ASSOC),
        Arguments.of(
            PropertyOwner.Relationship.LOCAL_AUTHORITY, ThirdPartyOwner.OwnerRelation.LOCAL_AUTH),
        Arguments.of(
            PropertyOwner.Relationship.PROPERTY_COMPANY,
            ThirdPartyOwner.OwnerRelation.PPROPERTY_CO),
        Arguments.of(
            PropertyOwner.Relationship.PARTNER_WITH_A_CONTRARY_INTEREST,
            ThirdPartyOwner.OwnerRelation.PARTNER_CONT),
