...
class ChildWeightingMapperTest {
  ...
  @BeforeEach
  void setUp() {
    childWeightingMapper = new ChildWeightingMapper();
  }
  ...
  private ChildWeighting getChildWeightingObject(
  ...
  void shouldMapDependantToAdapterChildWeighting(
      Integer age,
    ...
    List<ChildWeighting> actualChildWeightings =
        childWeightingMapper.mapChildWeighting(crimeApplyDependants);
