...
class OffenceClassMapperTest {
  ...
  void shouldMapFromCrimeApplyOffenceClassToCrimeApplicationsOffenceClass(
      ...
      uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails.OffenceClass
  ...
  private static Stream<Arguments> offenceClassMappingTestData() {
    return Stream.of(
        ...
        Arguments.of(
            ...
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.SERIOUS_VIOL_DRUGS),
        Arguments.of(
            CaseDetails.OffenceClass.C,
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.LESSER_VIOL_DRUGS),
        Arguments.of(
        ...
        Arguments.of(
            ...
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.BURGLARY),
        Arguments.of(
            CaseDetails.OffenceClass.F,
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.DISHONESTY_LT_30_K),
        Arguments.of(
            CaseDetails.OffenceClass.G,
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.DISHONESTY_30_K_100_K),
        Arguments.of(
        ...
        Arguments.of(
            ...
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.REVENUE_PUBLIC_ORDER),
        Arguments.of(
            CaseDetails.OffenceClass.J,
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.COMPLEX_SEX),
        Arguments.of(
            CaseDetails.OffenceClass.K,
            uk.gov.justice.laa.crime.model.common.crimeapplicationsadaptor.common.CaseDetails
                .OffenceClass.DISHONESTY_GT_100_K));
  }
}
