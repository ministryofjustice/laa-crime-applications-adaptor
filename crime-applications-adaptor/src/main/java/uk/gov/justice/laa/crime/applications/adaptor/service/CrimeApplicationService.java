...
public class CrimeApplicationService {
    ...
    public MaatCaaContract retrieveApplicationDetailsFromCrimeApplyDatastore(long usn) {
        ...
        MaatCaaContract maatCaaContract = crimeApplyMapper.mapToMaatApplication(crimeApplyMaatApplication);

        return Observation.createNotStarted(SERVICE_NAME, observationRegistry)
                .observe(() -> maatCaaContract);
    }
}
