  ...
  @NotNull InitialMeansAssessment map(IncomeDetails crimeApplyIncomeDetails) {
    ...
    if (Objects.nonNull(crimeApplyIncomeDetails.getBenefits())) {
      List<AssessmentDetail> benefits =
          benefitsMapper.mapBenefits(crimeApplyIncomeDetails.getBenefits());
    ...
    if (Objects.nonNull(crimeApplyIncomeDetails.getOtherIncome())) {
      List<AssessmentDetail> otherIncome =
          otherIncomeMapper.mapOtherIncome(crimeApplyIncomeDetails.getOtherIncome());
    ...
    initialMeansAssessment.setOtherBenefitNote(
        benefitsMapper.mapOtherBenefitNotes(crimeApplyIncomeDetails.getBenefits()));
    initialMeansAssessment.setOtherIncomeNote(
        otherIncomeMapper.mapOtherIncomeNotes(crimeApplyIncomeDetails.getOtherIncome()));
